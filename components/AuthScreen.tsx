  ...
  return (
      <div className="relative group">
          ...
          <button 
              ...
              className="absolute inset-y-0 right-0 pr-5 flex items-center text-zinc-400 hover:text-white cursor-pointer z-20 focus:outline-none"
          >
...
const AuthScreen: React.FC<AuthScreenProps> = React.memo(({ onComplete, onViewLegal, onBackHome }) => {
  ...
  const renderCard = (children: React.ReactNode, title: string, subtitle?: string) => (
          ...
          <div className="w-full max-w-sm flex flex-col items-center">
              <div className="text-center mb-12 w-full">
                  <motion.h2 
                    ...
                    className="text-5xl font-display font-bold tracking-tighter text-white mb-2"
                  >
                    {title}
                  </motion.h2>
                  {subtitle && (

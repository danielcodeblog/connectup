...
import { Mail, Lock, User, ArrowRight, ChevronLeft, ChevronRight, Lightbulb, Eye, EyeOff, Loader2, CheckCircle2, AlertCircle, Camera, MapPin, Landmark, ShieldCheck, KeyRound, Sparkles } from 'lucide-react';
    ...
    try {
        ...
        if (data.user) {
            ...
            if (role === UserRole.ADMIN) {
                ...
                setErrorMsg("🔒 Access Denied: Administrator accounts must log in through the Admin Portal.");
                setIsLoading(false);
                return;
            }
            if (role) {

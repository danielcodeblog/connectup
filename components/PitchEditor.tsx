  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="bg-white w-full h-full sm:h-auto sm:max-w-2xl sm:rounded-[48px] shadow-2xl overflow-hidden flex flex-col relative"
      >
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-8 py-8 space-y-10 no-scrollbar">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest ml-1">Video Pitch URL</label>
              <input 
                type="text" 

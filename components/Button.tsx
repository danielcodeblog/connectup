...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    // Primary: Gold Background, White/Black Text (High Contrast)
    primary: "bg-brand-primary text-black shadow-[0_4px_14px_rgba(255,208,0,0.3)] hover:shadow-[0_6px_20px_rgba(255,208,0,0.4)] hover:bg-white hover:text-black border border-yellow-400",
  ...
  const sizes = {
    ...
    md: "h-14 px-8 text-base rounded-sm",
    lg: "h-16 px-10 text-lg rounded-sm"
  };

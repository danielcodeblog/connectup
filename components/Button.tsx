...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    primary: "bg-brand-primary text-black shadow-[0_4px_14px_rgba(255,208,0,0.3)] hover:shadow-[0_6px_20px_rgba(255,208,0,0.4)] hover:bg-white hover:text-black border border-transparent",

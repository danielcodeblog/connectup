        ...
        {currentInfoOpen && memoCard && (
          ...
          >
            <div className="absolute top-4 w-full z-[90] flex justify-center">
              <button onClick={handleCloseMemo} className="w-10 h-10 rounded-full bg-white/40 backdrop-blur-md text-zinc-900 flex items-center justify-center border border-zinc-200">
                <X size={20} />
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto pb-24 no-scrollbar">
              <div className="p-6 max-w-2xl mx-auto pt-20">
                <div className="bg-white border border-zinc-200 rounded-3xl p-6 text-zinc-900 mb-6 shadow-xl">
                  <div className="flex gap-2 mb-3">
                    <span className="px-2 py-0.5 bg-zinc-100 text-zinc-600 rounded text-[10px] font-bold uppercase">{memoCard.industry}</span>
                  ...
                  <p className="text-zinc-500 text-sm leading-relaxed mb-4">{memoCard.oneLiner}</p>
                  <p className="text-zinc-700 text-sm leading-relaxed whitespace-pre-wrap">{memoCard.description}</p>
                </div>
                <div className="bg-white border border-zinc-200 rounded-3xl p-6 shadow-xl mb-6">
                  <div className="text-[10px] font-bold text-zinc-400 uppercase mb-2">Asks For</div>
                  <div className="text-2xl font-display font-bold text-zinc-900">${memoCard.askAmount?.toLocaleString()}</div>
                </div>
                <div className="space-y-4">
                  <h4 className="font-bold text-zinc-900 px-1">Founder</h4>
                  <div className="flex items-center gap-4 bg-white p-4 rounded-3xl border border-zinc-200 shadow-xl">
                    ...
                    <div>
                      <div className="font-bold text-zinc-900">{memoCard.founder.name}</div>
                      <div className="text-xs text-zinc-500">{memoCard.founder.role} • {memoCard.founder.location}</div>
                    </div>
                  </div>
                </div>
              </div>
...
const SwipeCard = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-30 flex flex-col justify-end p-6 pb-6 pointer-events-none">

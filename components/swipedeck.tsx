...
import { 
  X, ArrowUpRight, Info,
  Scan, Check, Filter, SendHorizontal, BriefcaseBusiness, ChevronLeft, RotateCw, BadgeCheck, MessageCircle, LayoutGrid, Users, Flame, Globe
} from 'lucide-react';
  ...
  return (
    <div className="h-full bg-[#FFFCF0] flex flex-col font-sans relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-[#FFFCF0] pointer-events-none">
          <div className="absolute top-[-10%] left-[-10%] w-[120%] h-[40%] sm:h-[60%] bg-brand-primary/30 rounded-[50%] blur-3xl opacity-60 animate-blob"></div>
      ...
      <div className="absolute top-0 left-0 right-0 z-[50] safe-area-top pt-3 sm:pt-6 flex justify-center pointer-events-none">
          <div className="text-base sm:text-lg font-display font-bold text-white tracking-tighter">
      ...
      {activeTab === 'community' ? (
          <div className="flex-1 overflow-hidden pt-24 pb-32 bg-transparent">
              <div className="max-w-4xl mx-auto h-full">
                  <CommunityFeed userProfile={userProfile} onMessage={(authorId) => {
      ...
      {cards.length === 0 && !matchedStartup && (
        <div className="w-full max-w-xl mx-auto h-full flex flex-col items-center justify-center relative z-10 bg-transparent text-zinc-900 overflow-hidden animate-in fade-in duration-500">
           ...
           <div className="relative mb-12">
               {/* Core Scanner */}
               <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full border border-zinc-200/50 flex items-center justify-center relative z-20 bg-white/50 backdrop-blur-xl shadow-2xl">
                   <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-white/50 to-transparent opacity-50"></div>
                   <Scan size={32} className="sm:size-12 text-brand-primary drop-shadow-[0_0_20px_rgba(255,208,0,0.6)]" strokeWidth={1.5} />
               </div>
           ...
           <div className="relative z-20 text-center px-6">
               <h2 className="text-2xl sm:text-4xl font-display font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-500 mb-3 tracking-tighter">
                 All Caught Up
               </h2>
           </div>
        </div>
            ...
            return (
              ...
              >
                 ...
                 <div className="absolute inset-0 z-30 flex flex-col justify-end pointer-events-none" onMouseDown={(e) => e.stopPropagation()} onTouchStart={(e) => e.stopPropagation()}>
                    ...
                    <div className="flex items-end justify-between px-4 pb-28 sm:pb-40 w-full">
                        ...
                        <div className="flex-1 mr-4 pointer-events-auto space-y-2 pb-1">
                            ...
                            {/* Title & Description */}
                            <div>
                                <h2 className="text-xl sm:text-3xl font-display font-black text-white leading-tight drop-shadow-lg mb-1">
                                {card.name}
                                </h2>
                            </div>
                        ...
                        <div className="flex flex-col gap-4 sm:gap-6 items-center pointer-events-auto pb-0 shrink-0">
                             
                             {/* Memo Button */}
                             <button onClick={handleOpenMemo} className="group flex flex-col items-center gap-1">
                                 <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-zinc-900/40 backdrop-blur-md border border-white/20 flex items-center justify-center text-white shadow-lg group-active:scale-90 transition-transform">
                                     <Info size={20} className="sm:size-6" strokeWidth={2.5} />
                                 </div>
                                 <span className="text-[9px] sm:text-[10px] font-bold text-white drop-shadow-md">Memo</span>
                             </button>
      ...
      {currentInfoOpen && memoCard && (
         ...
         >
             ...
             <div className="flex-1 overflow-y-auto pb-32 no-scrollbar bg-[#FFFCF0]" ref={memoContentRef}>

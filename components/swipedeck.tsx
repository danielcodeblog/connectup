...
import { 
  X, FileText, RefreshCcw, Check, MessageCircle, Flame, User, Flag, Volume2, VolumeX, AlertTriangle
} from 'lucide-react';
...
const SwipeCard = ({ card, isTop, isMuted, onToggleMute, onSwipe, onOpenMemo, onReport }: { card: Startup, isTop: boolean, isMuted: boolean, onToggleMute: () => void, onSwipe: (dir: 'left' | 'right') => void, onOpenMemo: () => void, onReport: (card: Startup) => void }) => {
  ...
  return (
    <motion.div
      ...
      onPointerUp={isTop ? cancelHold : undefined}
        ...
        <div className="flex items-end justify-end w-full">
          ...
          <div className="flex flex-col gap-3">
            {isVideo && (
              ...
              >
                <div className="w-12 h-12 rounded-full bg-black/40 backdrop-blur-md border border-white/20 flex items-center justify-center text-white shadow-lg group-active:scale-90 transition-transform hover:bg-black/60 pointer-events-auto">

...
export default function LandingSite({ onLoginClick, onLegalView }: LandingSiteProps) {
  ...
  return (
    <ShaderBackground paused={isMobileMenuOpen} className="font-poppins bg-[#0D0D0F] text-white min-h-screen flex flex-col relative selection:bg-[#EAB308] selection:text-black">
      ...
      >
        ...
        <nav className="flex flex-col items-center justify-start sm:justify-center flex-1 gap-4 mt-6 px-2 md:gap-8 md:mt-8 md:px-12 pt-2 sm:pt-6 md:pt-0">
          {(['home', 'about', 'blog', 'founders', 'contact'] as const).map((page, idx) => (
            <button
              key={page}
              onClick={() => {
                navigateTo(page);
        ...
        >
          <button
            ...
            className="inline-block px-10 py-5 bg-[#EAB308] text-black rounded-full font-black uppercase tracking-widest text-[10px] hover:scale-110 transition-transform shadow-2xl"
          >
            Get Started
          </button>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-16">
          ...
          <div id="contact" className="w-full">
            <div className="grid lg:grid-cols-2 gap-12 sm:gap-20 items-center">
              ...
              {/* Form Container */}
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 sm:p-8 md:p-10 rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl w-full relative overflow-hidden group">

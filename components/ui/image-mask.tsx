...
const ImageMask = React.forwardRef<HTMLDivElement, ComponentProps>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={className} {...props}>
      ...
      <section className='grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-8 bg-[#0D0D0F]/40 backdrop-blur-xl border border-white/10 rounded-lg p-3 sm:p-5 shadow-sm'>
        <figure style={{ clipPath: 'url(#clip-pattern)' }}>
          <img
            src='https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=60&w=800&auto=format&fit=crop'
            alt=''
        ...
        <figure style={{ clipPath: 'url(#clip-pattern1)' }}>
          <img
            src='https://images.unsplash.com/photo-1552664730-d307ca884978?q=60&w=800&auto=format&fit=crop'
            alt=''
            className='transition-all duration-300  aspect-[4/5] min-h-full   align-bottom object-cover  hover:scale-105 w-full'
            loading="lazy"
          />
        </figure>
        <figure style={{ clipPath: 'url(#clip-pattern2)' }} className="hidden sm:block">
          <img
        ...
        <figure style={{ clipPath: 'url(#clip-pattern4)' }} className="hidden sm:block">
          <img
        ...
        <figure style={{ clipPath: 'url(#clip-pattern7)' }}>
          <img
            src='https://images.unsplash.com/photo-1553877522-43269d4ea984?q=60&w=800&auto=format&fit=crop'
            alt=''
            className='transition-all duration-300  aspect-[4/5] min-h-full   align-bottom object-cover  hover:scale-105 w-full'
            loading="lazy"
          />
        ...
        <figure style={{ clipPath: 'url(#clip-pattern8)' }}>
          <img
            src='https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=60&w=800&auto=format&fit=crop'
            alt=''
            className='transition-all duration-300  aspect-[4/5] min-h-full   align-bottom object-cover  hover:scale-105 w-full'
            loading="lazy"
          />

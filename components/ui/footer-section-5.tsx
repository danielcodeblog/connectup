...
export default function FooterSection5({ onNavigate, onLegalView }: FooterSection5Props) {
  ...
  return (
    <footer className="w-full bg-[#FFBF00] relative overflow-hidden antialiased [font-synthesis:none] border-t border-black/10">
      {/* Accent gradient line at the top of the footer */}
      <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-white/50 via-black/10 to-transparent z-20" />

      {/* Main Panel Section */}
      <div className="relative w-full bg-[#FFBF00] z-10 min-h-[350px]">
        {/* Background Shader */}
        ...
        {/* Ambient Glows */}
        <div className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[380px] h-[380px] rounded-full bg-[#E0B0FF]/30 blur-[90px] pointer-events-none z-0" />
        <div className="absolute bottom-12 right-1/4 translate-x-1/2 w-[300px] h-[300px] rounded-full bg-[#CFB53B]/30 blur-[80px] pointer-events-none z-0" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-16 md:py-20 flex flex-col justify-between gap-16">
          <div className="flex flex-col md:flex-row justify-between gap-16 md:gap-8 items-start">
            ...
            <div className="flex flex-col justify-between max-w-[300px] w-full relative z-10">
              <div className="flex flex-col">
                ...
                <p className="text-zinc-900/70 text-sm mt-3 font-medium leading-relaxed max-w-[280px]">
          ...
          <div className="pt-8 border-t border-black/10 flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
            <p className="font-medium text-zinc-950/70 text-xs md:text-[13px]">

...
export const ChatInterface: React.FC<ChatInterfaceProps> = React.memo(({ 
  ...
  return (
    <div className="flex h-full bg-[#F5F5F5] relative overflow-hidden font-sans">
      ...
      `}>
        {/* Header */}
        <div className="px-5 py-4 border-b border-zinc-100 bg-white/80 backdrop-blur-md sticky top-0 z-10 pt-safe-top">
             ...
             <div className="divide-y divide-zinc-50">
               {filteredChats.map(chat => (
                 <button
                   ...
                   className={`w-full p-4 flex items-center gap-4 hover:bg-zinc-50 transition-colors text-left group ${selectedChatId === chat.id ? 'bg-zinc-50' : ''}`}
                 >
      ...
      `}>
        {selectedChatId ? (
          <>
            {/* Chat Header */}
            <div className="bg-white/80 backdrop-blur-xl border-b border-zinc-200 px-4 py-3 flex items-center justify-between shrink-0 sticky top-0 pt-safe-top z-20 shadow-sm">

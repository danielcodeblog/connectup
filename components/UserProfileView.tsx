          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                {profile.plan === 'pro' && (
                  <BadgeCheck className="text-brand-primary" size={24} strokeWidth={2.5} />
                )}
              </div>
            ...
            <div className="space-y-4">
              {posts.map(post => (
                <div key={post.id} className="border-b border-zinc-800 pb-4 last:border-0">
                  ...
                  <p className="text-sm text-zinc-350 mb-3">{post.content}</p>
                  {post.imageUrl && (
                    <img src={post.imageUrl} className="w-full rounded-2xl mb-3 border border-zinc-800" alt="Post" />
                  )}

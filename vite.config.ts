    ...
    return {
      ...
      build: {
        ...
        rollupOptions: {
          output: {
            manualChunks: {
              'vendor': ['react', 'react-dom', 'lucide-react', 'axios', 'motion', 'gsap'],
            },
          },
        },
      ...
      define: {
        ...
        'process.env.VITE_PAYSTACK_PUBLIC_KEY': JSON.stringify(env.VITE_PAYSTACK_PUBLIC_KEY || process.env.VITE_PAYSTACK_PUBLIC_KEY || '')
      },
      resolve: {
        alias: {

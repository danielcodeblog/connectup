...
const supabaseUrl = getEnvVar('VITE_SUPABASE_URL', 'VITE_SUPABASE_URL') || getEnvVar('VITE_SUPABASE_URL', 'SUPABASE_URL');
const supabaseKey = getEnvVar('VITE_SUPABASE_ANON_KEY', 'VITE_SUPABASE_ANON_KEY') || getEnvVar('VITE_SUPABASE_ANON_KEY', 'SUPABASE_KEY');
